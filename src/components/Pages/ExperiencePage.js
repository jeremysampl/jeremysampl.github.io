            ...
            >
                <div style={{textAlign: 'left'}}>
                    ...
                    <ul style={{margin: '10px 10px 10px 30px', fontSize: isMobile ? 18 : 22, gap: 10, display: 'flex', flexDirection: 'column'}}>
                        <li>Lead the development of a new point of sale (POS) system for their café.
                        ...
                        <li>Lead the development of a new chits app for ordered food and drinks.
                            <ul style={{marginLeft: 30}}>
                                <li>Replaced an outdated system with a new lightweight React app, offering significantly improved integration with their pre-existing systems.</li>
                                <li>Displays and controls incoming chits, printing them to the desired location when ready.</li>
                                <li>Offers significant integration with the POS system, such as almost instantaneous chit receival due to seamless connections between all devices.</li>
                            </ul>
                        </li>
                        <li>Created WordPress plugins to add new features to their website, as well as update existing ones.</li>
