import { type EducationId } from './courses';
...
export type AboutEducationEntry = AboutEntry & {
	id: EducationId;
};
...
export const educationEntries: AboutEducationEntry[] = [
	{
		id: 'mcmaster',
		...
		detail: 'GPA: 3.96 / 4.0',
		points: [
			'Named to the Provost\'s Honour Roll for achieving a grade of 90% or higher in every course across an entire academic year.',
		],
	},
];

export const leadershipEntries: AboutEntry[] = [
	{
		id: 'mcss-academic-manager',
